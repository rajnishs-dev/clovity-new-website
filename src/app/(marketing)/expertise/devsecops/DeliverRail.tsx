...
/**
 * The six-piece card rail: four cards visible, the rest reached with the
 * prev/next buttons. Same treatment as the ITSM and Managed Services pages'
 * `DeliverRail` - see the ITSM file for the fuller rationale on the hover
 * reveal and the scroll-snap.
 *
 ...
 *
 * ── THE HOVER REVEAL ──
 * Default face: coloured card, piece title, a large ghosted icon. Revealed
 ...
 * Same palette as the ITSM and Managed Services rails, already softened ~22%
 * toward white from the logo's raw values. Six cards over five colours, so the
 * sixth restarts the series.
 *
 ...
 * fills are shared across the three rails and should stay in step.
 *
